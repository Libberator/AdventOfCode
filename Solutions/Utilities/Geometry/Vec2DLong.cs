...
public readonly record struct Vec2DLong(long X, long Y) : ISpanParsable<Vec2DLong>, ISpanFormattable
{
    ...
    public static IEnumerable<Vec2DLong> GeneratePoints(long xMax, long yMax, long xMin = 0, long yMin = 0)
    {
    ...
    public static IEnumerable<Vec2DLong> GeneratePointsInclusive(long xMax, long yMax, long xMin = 0, long yMin = 0)
    {
        for (var x = xMin; x <= xMax; x++)
            for (var y = yMin; y <= yMax; y++)
                yield return new Vec2DLong(x, y);
    ...
    /// </summary>
    public static (float tX, float tY) InverseLerp(Vec2DLong value, Vec2DLong a, Vec2DLong b)
    {
    ...
    /// </summary>
    public static (float tX, float tY) InverseLerpClamped(Vec2DLong value, Vec2DLong a, Vec2DLong b)
    {
    ...
    public static Vec2DLong Lerp(Vec2DLong a, Vec2DLong b, float weight)
    {
    ...
    public static Vec2DLong Map(Vec2DLong value, Vec2DLong fromMin, Vec2DLong fromMax, Vec2DLong toMin, Vec2DLong toMax)
    {
